...
const EXPERIENCE = [
    {
        ...
        description: 'Leading the backend development team, architecting scalable microservices, and optimizing database performance for high-traffic applications.',
    ...
    },
    {
        ...
        description: 'Developed responsive frontend interfaces using React.js, collaborated with the design team to implement UI/UX best practices, and wrote unit tests.',
    ...
    },
    {
        ...
        description: 'Built custom websites and web applications for local businesses, focusing on performance, SEO, and seamless user experiences.',
